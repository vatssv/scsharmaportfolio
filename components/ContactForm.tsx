...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:scsharma.dscl@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-lg font-semibold">scsharma.dscl@gmail.com</div>
              </div>
            </div>
